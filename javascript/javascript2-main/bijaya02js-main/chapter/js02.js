...
//document.getElementById("photoNum").onclick=setupForm;
...
function getEstimate() {
      ...
      totalCost += photographers * hours * EMP_COST;  // Add the cost of photographers for the hours covered
      totalCost += photographers * distance * TRAVEL_COST; // Add the cost of distance per photographer per mile
