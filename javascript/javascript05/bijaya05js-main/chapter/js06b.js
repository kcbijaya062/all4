...
// Check if the name is entered on the card
function validateName() {
   ...
   {
cardName.setCustomValidity("At least 5 chars");
   }
   else {
...
function validateCVC() {
   ...
   let cardel = document.querySelector('input[name="credit"]:checked');
   if (!cardel) return;
...
// Define the luhn function at the bottom
function luhn(idNum) {
   let string1 = "";
   let string2 = "";
